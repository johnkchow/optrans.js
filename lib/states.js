...
function logOp(msg, op) {
  _logger2.default.debug(msg + ' - ' + op.toString());
}
...
var AwaitingAckState = exports.AwaitingAckState = function () {
  ...
  _createClass(AwaitingAckState, [{
    ...
    value: function applyServer(op) {
      ...
      _logger2.default.debug('AwaitingAckState - composing op to serverBuffer');
      ...
      _logger2.default.debug('clientPrime: ' + clientPrime.toString());
      ...
      _logger2.default.debug('AwaitingAckState - composing serverPrime to clientBuffer');
